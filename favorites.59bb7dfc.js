function e(e,t,i,r){Object.defineProperty(e,t,{get:i,set:r,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var i="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},r={},a={},s=i.parcelRequired7c6;function o(e){return document.querySelector(e)}function n(e,t,i){e.style[t]=i}function c(e){let t=[...e].map(e=>e.category?.toLowerCase());return[...new Set(t)]}null==s&&((s=function(e){if(e in r)return r[e].exports;if(e in a){var t=a[e];delete a[e];var i={id:e,exports:{}};return r[e]=i,t.call(i.exports,i,i.exports),i.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){a[e]=t},i.parcelRequired7c6=s),s.register("kyEFX",function(t,i){e(t.exports,"register",function(){return r},function(e){return r=e}),e(t.exports,"resolve",function(){return a},function(e){return a=e});var r,a,s={};r=function(e){for(var t=Object.keys(e),i=0;i<t.length;i++)s[t[i]]=e[t[i]]},a=function(e){var t=s[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),s("kyEFX").register(JSON.parse('{"iGlSd":"favorites.59bb7dfc.js","5RfUc":"card.df7e8656.png","9SZS3":"like.15c77fd6.svg","jL7vR":"no_like.af71eca1.svg","cgZ4r":"star_fill.6e74fda4.svg","3yHF3":"star_no_fill.3faee62c.svg","6smQV":"empty_favorites.b72238c0.svg","kaY2C":"favorites.a9b09bac.js","1XaNB":"favorites.e8d10294.css"}')),new URL(s("kyEFX").resolve("5RfUc"),import.meta.url).toString();const l="recipes";function f(e,t){let i=function(e){try{return JSON.stringify(e)}catch(e){console.log(e),console.log(e.message)}}(t);localStorage.setItem(e,i)}function d(e){return localStorage.getItem(e)}function v(e){try{return JSON.parse(e)}catch(e){console.log(e),console.log(e.message)}}function _(e,t){let i=`
    ...
    `;return l})(e)).join("");H.ulCards.innerHTML=t}function b({isEmpty:e}){e&&(matchMedia("(max-width: 767px)").matches&&n(H.hero_favorite,"display","none"),n(H.categoryDiv,"display","none"),n(H.cardsDiv,"display","none"),n(H.paginationDiv,"display","none"),H.favorites_container.innerHTML+=function(){let e=t(S),i=`
        ...
        </div>`;return i}())}function L(e){let t=[...e.parentNode.children];t.map(e=>(function(e,t){e.classList.remove(t)})(e,"active")),function(e,t){e.classList.add(t)}(e,"active")}S=new URL(s("kyEFX").resolve("6smQV"),import.meta.url).toString();const H={favorites_container:o(".my-favorites__container"),hero_favorite:o(".my-favorites__hero"),categoryDiv:o(".my-favorites__category"),cardsDiv:o(".my-favorites__cards"),ulCategories:o(".my-favorites-category__list"),ulCards:o(".my-favorites-cards__list"),paginationDiv:o(".pagination-wrap")},C={favorites:[],currentCategories:"all categories",all(){return this.favorites},filter(e){return this.favorites.filter(e)}},F=v(d(l));F?C.favorites=F:f(l,C.favorites),window.addEventListener("resize",()=>{let e=window.matchMedia("(max-width: 768px)");e?.matches&&C.favorites?.length}),C.favorites?.length?(C.categories=c(C.favorites),w(C.categories,C.currentCategories),E(C.favorites),H.ulCards.addEventListener("click",function(e){let t=e.target,i=t.classList.contains("favorite-heart");if("IMG"===t.nodeName&&i){let e=t.closest(".card__item");if(function({id:e,element:t}){C.favorites=C.favorites.filter(t=>t.id!==e),f(l,C.favorites),t.remove()}({id:e.id,element:e}),v(d(l))?.length||b({isEmpty:!0}),C.categories=c(C.favorites),w(C.categories),C.categories.includes(C.currentCategories)){let e=[...H.ulCategories.children].find(e=>e.textContent.trim().toLowerCase()==C.currentCategories.trim().toLowerCase());L(e)}else console.log(C),w(C.categories),E(C.all())}}),H.ulCategories.addEventListener("click",e=>{let t=e.target,i=t.textContent.trim().toLowerCase(),r=t.classList.contains("text-item-category");if("SPAN"===t.nodeName&&r){if("all categories"===i){let e=C.all();L(t),E(e)}else{C.currentCategories=i;let e=C.filter(e=>e.category.toLowerCase()==i.toLowerCase());L(t),E(e)}}})):b({isEmpty:!0}),s("7rYDH"),s("8awsR"),s("8igf3"),s("2nhTy"),s("4S0r6"),s("9RVUD");
//# sourceMappingURL=favorites.59bb7dfc.js.map
