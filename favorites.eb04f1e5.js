!function(){function e(e,t,i,r){Object.defineProperty(e,t,{get:i,set:r,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var i="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},r={},a={},n=i.parcelRequired7c6;function s(e){let t=[...e].map(e=>e.category?.toLowerCase());return[...new Set(t)]}null==n&&((n=function(e){if(e in r)return r[e].exports;if(e in a){var t=a[e];delete a[e];var i={id:e,exports:{}};return r[e]=i,t.call(i.exports,i,i.exports),i.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){a[e]=t},i.parcelRequired7c6=n),n.register("iE7OH",function(t,i){e(t.exports,"register",function(){return r},function(e){return r=e}),e(t.exports,"resolve",function(){return a},function(e){return a=e});var r,a,n={};r=function(e){for(var t=Object.keys(e),i=0;i<t.length;i++)n[t[i]]=e[t[i]]},a=function(e){var t=n[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),n.register("aNJCr",function(t,i){e(t.exports,"getBundleURL",function(){return r},function(e){return r=e});var r,a={};r=function(e){var t=a[e];return t||(t=function(){try{throw Error()}catch(t){var e=(""+t.stack).match(/(https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/[^)\n]+/g);if(e)return(""+e[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),a[e]=t),t}}),n("iE7OH").register(JSON.parse('{"bN78u":"favorites.eb04f1e5.js","aZCCQ":"like.15c77fd6.svg","7xGU9":"no_like.af71eca1.svg","7Acci":"star_fill.6e74fda4.svg","lBtJ9":"star_no_fill.3faee62c.svg","gidvd":"empty_favorites.b72238c0.svg","3JAeC":"favorites.3c08da69.js","1XaNB":"favorites.703d2abf.css"}')),n("9nKIm");let o="recipes";function l(e,t){let i=function(e){try{return JSON.stringify(e)}catch(e){console.log(e),console.log(e.message)}}(t);localStorage.setItem(e,i)}function c(e){return localStorage.getItem(e)}function d(e){try{return JSON.parse(e)}catch(e){console.log(e),console.log(e.message)}}var f=n("9nKIm");function v(e,t){let i=`
    ...
    `;return i}var u={};u=n("aNJCr").getBundleURL("bN78u")+n("iE7OH").resolve("aZCCQ");var _={};_=n("aNJCr").getBundleURL("bN78u")+n("iE7OH").resolve("7xGU9");let g={like:t(u),no_like:t(_)};var m={};m=n("aNJCr").getBundleURL("bN78u")+n("iE7OH").resolve("7Acci");var p={};p=n("aNJCr").getBundleURL("bN78u")+n("iE7OH").resolve("lBtJ9");let y={star_fill:t(m),star_no_fill:t(p)};var h={};function C(e,t){if(!Array.isArray(e))return null;let i=e.map((e,i)=>0===i?`
            ...
            ${v(e,t)}
            `:v(e,t)).join("");w.ulCategories.innerHTML=i}function E(e){if(!Array.isArray(e))return null;let t=[...e].map(e=>(function(e){let{id:t,image:i,name:r,description:a,rating:n,isFavorites:s=!0}=e,o=function(e){let{isFavorites:t}=e,i=t?g.like:g.no_like,r=`
    ...
    `;return c})(e)).join("");w.ulCards.innerHTML=t}function b({isEmpty:e}){e&&(matchMedia("(max-width: 767px)").matches&&(0,f.elementstyle)(w.hero_favorite,"display","none"),(0,f.elementstyle)(w.categoryDiv,"display","none"),(0,f.elementstyle)(w.cardsDiv,"display","none"),(0,f.elementstyle)(w.paginationDiv,"display","none"),w.favorites_container.innerHTML+=function(){let e=t(h),i=`
        ...
        </div>`;return i}())}function H(e){let t=[...e.parentNode.children];t.map(e=>(0,f.removeClass)(e,"active")),(0,f.addClass)(e,"active")}h=n("aNJCr").getBundleURL("bN78u")+n("iE7OH").resolve("gidvd");var f=n("9nKIm");let w={favorites_container:(0,f.findElement)(".my-favorites__container"),hero_favorite:(0,f.findElement)(".my-favorites__hero"),categoryDiv:(0,f.findElement)(".my-favorites__category"),cardsDiv:(0,f.findElement)(".my-favorites__cards"),ulCategories:(0,f.findElement)(".my-favorites-category__list"),ulCards:(0,f.findElement)(".my-favorites-cards__list"),paginationDiv:(0,f.findElement)(".pagination-wrap")},x={favorites:[],currentCategories:"all categories",all(){return this.favorites},filter(e){return this.favorites.filter(e)}},N=d(c(o));N?x.favorites=N:l(o,x.favorites),window.addEventListener("resize",()=>{let e=window.matchMedia("(max-width: 768px)");e?.matches&&x.favorites?.length}),x.favorites?.length?(x.categories=s(x.favorites),C(x.categories,x.currentCategories),E(x.favorites),handleIsHiddenPaginationGavorite(x.favorites),w.ulCards.addEventListener("click",function(e){let t=e.target,i=t.classList.contains("favorite-heart");if("IMG"===t.nodeName&&i){let e=t.closest(".card__item");if(function({id:e,element:t}){x.favorites=x.favorites.filter(t=>t.id!==e),l(o,x.favorites),t.remove()}({id:e.id,element:e}),d(c(o))?.length||b({isEmpty:!0}),x.categories=s(x.favorites),C(x.categories),x.categories.includes(x.currentCategories)){let e=[...w.ulCategories.children].find(e=>e.textContent.trim().toLowerCase()==x.currentCategories.trim().toLowerCase());H(e),handleIsHiddenPaginationGavorite(x.favorites)}else console.log(x),C(x.categories),E(x.all()),handleIsHiddenPaginationGavorite(x.favorites)}}),w.ulCategories.addEventListener("click",e=>{let t=e.target,i=t.textContent.trim().toLowerCase(),r=t.classList.contains("text-item-category");if("SPAN"===t.nodeName&&r){if("all categories"===i){let e=x.all();H(t),E(e),handleIsHiddenPaginationGavorite(e)}else{x.currentCategories=i;let e=x.filter(e=>e.category.toLowerCase()==i.toLowerCase());H(t),E(e),handleIsHiddenPaginationGavorite(e)}}})):b({isEmpty:!0}),n("b7ONl"),n("2hTvb"),n("jcFG7"),n("9VC5X"),n("dmpts"),n("gJMjQ")}();
//# sourceMappingURL=favorites.eb04f1e5.js.map
