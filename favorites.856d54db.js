function e(e,t,i,r){Object.defineProperty(e,t,{get:i,set:r,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var i="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},r={},a={},s=i.parcelRequired7c6;function o(e){return document.querySelector(e)}function n(e,t,i){e.style[t]=i}function c(e){let t=[...e].map(e=>e.category?.toLowerCase());return[...new Set(t)]}null==s&&((s=function(e){if(e in r)return r[e].exports;if(e in a){var t=a[e];delete a[e];var i={id:e,exports:{}};return r[e]=i,t.call(i.exports,i,i.exports),i.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){a[e]=t},i.parcelRequired7c6=s),s.register("kyEFX",function(t,i){e(t.exports,"register",function(){return r},function(e){return r=e}),e(t.exports,"resolve",function(){return a},function(e){return a=e});var r,a,s={};r=function(e){for(var t=Object.keys(e),i=0;i<t.length;i++)s[t[i]]=e[t[i]]},a=function(e){var t=s[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),s("kyEFX").register(JSON.parse('{"iGlSd":"favorites.856d54db.js","5RfUc":"card.df7e8656.png","9SZS3":"like.15c77fd6.svg","jL7vR":"no_like.af71eca1.svg","cgZ4r":"star_fill.6e74fda4.svg","3yHF3":"star_no_fill.3faee62c.svg","6smQV":"empty_favorites.b72238c0.svg","3WN0C":"favorites.44e496e8.js","1XaNB":"favorites.c63fa1eb.css"}')),new URL(s("kyEFX").resolve("5RfUc"),import.meta.url).toString();const l="recipes";function f(e,t){let i=function(e){try{return JSON.stringify(e)}catch(e){console.log(e),console.log(e.message)}}(t);localStorage.setItem(e,i)}function d(e){return localStorage.getItem(e)}function v(e){try{return JSON.parse(e)}catch(e){console.log(e),console.log(e.message)}}function _(e,t){let i=`
    ...
    `;return i}var u={};u=new URL(s("kyEFX").resolve("9SZS3"),import.meta.url).toString();var g={};g=new URL(s("kyEFX").resolve("jL7vR"),import.meta.url).toString();const m={like:t(u),no_like:t(g)};var y={};y=new URL(s("kyEFX").resolve("cgZ4r"),import.meta.url).toString();var p={};p=new URL(s("kyEFX").resolve("3yHF3"),import.meta.url).toString();const h={star_fill:t(y),star_no_fill:t(p)};var S={};function w(e,t){if(!Array.isArray(e))return null;let i=e.map((e,i)=>0===i?`
            ...
            ${_(e,t)}
            `:_(e,t)).join("");C.ulCategories.innerHTML=i}function E(e){if(!Array.isArray(e))return null;let t=[...e].map(e=>(function(e){let{id:t,image:i,name:r,description:a,rating:s,isFavorites:o=!0}=e,n=function(e){let{isFavorites:t}=e,i=t?m.like:m.no_like,r=`
    ...
    `;return l})(e)).join("");C.ulCards.innerHTML=t}function L({isEmpty:e}){e&&(matchMedia("(max-width: 767px)").matches&&n(C.hero_favorite,"display","none"),n(C.categoryDiv,"display","none"),n(C.cardsDiv,"display","none"),n(C.paginationDiv,"display","none"),C.favorites_container.innerHTML+=function(){let e=t(S),i=`
